...
public class GravityScript : MonoBehaviour
{
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        else if (collision.gameObject.CompareTag("FloorL"))
        {
        ...
        else if (collision.gameObject.CompareTag("FloorR"))
        {
        ...
        else if (collision.gameObject.CompareTag("FloorUP"))
        {
        ...
        else if (collision.gameObject.CompareTag("FloorZP"))
        {
        ...
        else if (collision.gameObject.CompareTag("FloorZM"))
        {
